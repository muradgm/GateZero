# TRD-250 Command Center CI Metadata Refresh After TRD-249
...
- Update static command-center fallback metadata for run `27737177617`.
...
- Command center latest packet displays `TRD-250`.
- Command center CI run displays `27737177617`.
- Command center last verified commit displays `8c4c0dc`.
- Command center review coverage displays `250 / 250`.
