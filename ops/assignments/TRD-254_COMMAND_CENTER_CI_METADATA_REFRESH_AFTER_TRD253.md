# TRD-254 Command Center CI Metadata Refresh After TRD-253
...
- Update static command-center fallback metadata for run `27737830833`.
...
- Command center latest packet displays `TRD-254`.
- Command center CI run displays `27737830833`.
- Command center last verified commit displays `44121b7`.
- Command center review coverage displays `254 / 254`.
