...
- The skill is explicitly bounded to Gate 0 research-only risk governance review.
...
- Intake record: `docs/operations/GATE0_RISK_GOVERNANCE_REVIEWER_SKILL_INTAKE.md`
- Skill: `skills/gatezero-risk-governance-reviewer/SKILL.md`
