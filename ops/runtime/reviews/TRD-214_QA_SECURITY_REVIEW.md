...
- The skill is explicitly bounded to Gate 0 research-only QA/security review.
...
- Intake record: `docs/operations/GATE0_QA_SECURITY_REVIEWER_SKILL_INTAKE.md`
- Skill: `skills/gatezero-qa-security-reviewer/SKILL.md`
