...
TRD-028 adds local issue register comparison while preserving Gate 0 Research Only.
...
- Issue changes remain local evidence-check differences only.
...
The local issue register comparison is not an approval workflow, UI workflow, report export format,
