...
TRD-054 preserves Gate 0 Research Only operation while adding a local tracklist consistency check.

## Scope Reviewed

- Tracklist consistency script.
- Tracklist consistency tests.
- Tracklist update.
