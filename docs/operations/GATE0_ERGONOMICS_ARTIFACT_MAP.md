...
| `TRD-424` | Gate 2 contract source                   | `packages/contracts/src/gate2-paper-simulation-contracts.ts`                                 | Defines local Gate 2 paper simulation schemas.                   |
| `TRD-430` | Gate 2 contract tests                    | `packages/contracts/tests/gate2-paper-simulation-contracts.test.ts`                          | Tests Gate 2 contract boundaries and negative cases.             |
| `TRD-429` | Gate 2 fixture source                    | `packages/fixtures/src/gate2-paper-simulation-fixtures.ts`                                   | Defines synthetic Gate 2 paper simulation fixtures.              |
| `TRD-429` | Gate 2 fixture tests                     | `packages/fixtures/tests/gate2-paper-simulation-fixtures.test.ts`                            | Tests Gate 2 fixture boundaries.                                 |
| `TRD-444` | Gate 2 local simulation engine           | `packages/core/src/gate2-local-simulation-engine.ts`                                         | Produces deterministic local-only simulation results.            |
| `TRD-444` | Gate 2 local simulation engine tests     | `packages/core/tests/gate2-local-simulation-engine.test.ts`                                  | Tests pass, blocked input, and boundary mutation paths.          |
...
| `TRD-263` | Gate 1 transition authorization          | `docs/operations/GATE1_TRANSITION_AUTHORIZATION.md`                                          | Authorizes the Gate 1 historical-backtesting transition.         |

## Review Records

Each ergonomics or foundation-control packet from `TRD-044` through `TRD-263` has:
